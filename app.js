...
async function createPlaylist() {
    ...
    try {
        ...
        if (
            ...
            msg(
                `⏸️ Quedaron ${resolution.pendingCount} canciones pendientes. No creé la playlist para evitar una lista incompleta. Presiona Crear Playlist otra vez para continuar.`
            );
